 ...
 * GNGS parser
 * 
 * This is a copy of the commons-cli default parser, but with the behavior for 
 * handling multiple-valued arguments modified.
 * 
 * @version $Id: DefaultParser.java 1783175 2017-02-16 07:52:05Z britter $
 * @since 1.3
 */
public class GngsCliParser extends DefaultParser
{
     ...
     * @throws ParseException
     */
    private void processToken(String token) throws ParseException
    {
        currentToken = token;
